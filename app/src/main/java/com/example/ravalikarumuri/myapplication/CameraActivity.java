...
public class CameraActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        visitor = (Visitor) getIntent().getSerializableExtra("VisitorDetails");
    ...
    private void previewCapturedImage() {
        try {
            ...
            visitor.setImage(byteArray);
            Button btnnext = (Button) findViewById(R.id.next2);
            btnnext.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View view) {
                    Intent intent = new Intent(CameraActivity.this, CaptureSignature.class);
